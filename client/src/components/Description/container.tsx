...
const Description : React.FC<PropsWithChildren<props>> = ({ requestStatus, setRequestStatus }) => {
  ...
  return (
    <Wrapper data-css='Description'>
      Input the text you wish to check, and using the <a href="https://sentim-api.herokuapp.com/" target="_blank" rel="noopener noreferrer">SENTIM-API</a> you will get a score on the sentiment:
    </Wrapper>
  )
}
